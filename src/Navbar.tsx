  ...
  return (
    <>
        ...
        <div>
          {isAuthenticated ? (
            <div className="flex relative">
              <div
                className={`m-0 flex gap-0 items-center
                            transition-all
                            ease-in-out
                            duration-500
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    <div
                      className={`flex items-center gap-3 m-auto px-4 border-x-white border-x-1 ${
                  ...
                  {mostrarDesplegableUsuario && (
                    <div className={`absolute z-50 mt-0 w-1/1`}>
                      <DesplegableUsuario
                        ...
                        cambiarDesplegableUsuario={cambiarDesplegableUsuario}
                      />
                    </div>
                  )}
                </div>
            ...
            <div className="p-5 flex gap-2 *:max-md:px-1">
              <button
                onClick={abrirInicioSesionUs}
                className="text-white font-lato p-1 max-md:p-0"
                type="button"
              >
                Iniciar Sesion
              </button>
              ...
              <button
                ...
                className=" bg-white rounded font-lato p-1 max-md:p-0"
                type="button"
              >
                Registrarse
              </button>
      ...
      <RegistroModal
        ...
        onClose={cerrarRegistroModal}
      />
      <InicioSesionUs
        isOpen={isInicioSesionUsOpen}
        onClose={cerrarInicioSesionUs}
      />
    </>
  );
}
