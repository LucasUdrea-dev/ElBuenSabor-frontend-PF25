...
export default function AdminInsumo() {
    ...
    const [modificarStock, setModificarStock] = useState<ModificarStock>({articulo: new ArticuloInsumo(), operacion: ""})
            ...
            <div className="bg-[#333333] w-full min-h-screen py-10">
                ...
                <div className={`bg-white w-11/12 m-auto rounded-2xl ${(mostrarArticulo || formInsumo) && "hidden"}`}>
                    ...
                    <div className="flex justify-between p-5 h-2/12">
                        ...
                        <div className="flex gap-5 pr-[2%] text-2xl">
                            <button onClick={()=>setMostrarStocks((prev)=>!prev)} className="bg-[#D93F21] text-white px-10 rounded-4xl flex items-center gap-2">
                                    ...
                                    if (index < (paginaSeleccionada*cantidadPorPagina) && index >= (cantidadPorPagina*(paginaSeleccionada-1))) {
                                        ...
                                        return(
                                            ...
                                            <div key={articulo.id} className="text-4xl w-full grid grid-cols-5 *:border-1 *:border-r-0 *:border-gray-500 *:w-full *:p-5 *:border-collapse text-center *:flex *:items-center *:justify-center">
                                                ...
                                                <h3>{articulo.stockArticuloInsumo.cantidad} {articulo.unidadMedida.unidad}{(articulo.unidadMedida.unidad == "unidad" && articulo.stockArticuloInsumo.cantidad != 1) && "es" }</h3>
                                                <div className="flex">
                ...
                */}
                ...
                <div className={`${!modificarStock.operacion && "hidden"}`}>
                    ...
                    <ModificarStock modificar={modificarStock} cerrarModal={cerrarModificarStock} />
