...
export default function AdminFormSubcategoria({subcategoria, cerrarEditar, cargarAdminSubcategoria}: Props) {
    ...
    const guardarSubcategoria = async (form: Subcategoria)=>{
        let URL = form.id ? host+`/api/subcategoria/${form.id}`
        : host+`/api/subcategoria`;
    ...
    return(
        <>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-[1fr_50fr] gap-2 items-center">
                            ...
                            <div className=" text-3xl">
                                <h2>{form.id ? "Modificar subcategoria" : "Crear subcategoria"}</h2>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-[1fr_50fr] gap-2 items-center">
                            ...
                            <div className={`text-2xl *:py-5`}>
                                ...
                                <div className="flex gap-5">
                                    ...
                                    <button onClick={()=>setSelectorCategoria(true)} className="bg-[#D93F21] px-5 rounded-2xl">Asignar</button>
                                </div>
                                {!form.categoria?.id &&(
                                    <h4>Debe asignarle una categoria</h4>
                                )}
                                ...
                                <div className="flex justify-between gap-5 *:p-2 *:rounded-4xl">
                                    ...
                                    <button onClick={()=>(form.denominacion && form.categoria?.id) ? handleSubmit() : ()=>{}} className="bg-[#D93F21]">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <SelectorCategoria abierto={selectorCategoria} cerrar={cerrarSelectorCategoria} setForm={setForm}/>
