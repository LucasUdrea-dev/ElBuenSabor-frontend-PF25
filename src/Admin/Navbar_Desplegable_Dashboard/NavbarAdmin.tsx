          ...
          {isAuthenticated ? (
            <div className="m-0 grid grid-cols-[3fr_1fr] gap-0 items-center">
              <div className="relative">
                <button
                  className="m-auto"
                  onClick={cambiarDesplegableAdmin}
                  type="button"
                >
                  <div
                    className={`flex items-center gap-3 m-auto px-4 border-x-white border-x-1 ${
                      mostrarDesplegableAdmin && "border-y-1 border-y-gray-700"
                    }`}
                  >
                    <img
                      className="w-10 h-10 rounded-full object-cover"
                      src={imagenEmpleado || "/svg/ImagenUsuario.svg"}
                      alt="foto usuario"
                    />
                    <label className="flex items-center hover:cursor-pointer text-white h-15 m-auto font-lato">
                      ...
                      <svg
                        className={`ml-1 h-4 w-4 transition-transform duration-200 ${
                          mostrarDesplegableAdmin ? "rotate-180" : "rotate-0"
                        }`}
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                {mostrarDesplegableAdmin && (
                  <div className="absolute z-50 mt-0 w-1/1">
                    <DesplegableAdmin
                      ...
                      cambiarDesplegableAdmin={cambiarDesplegableAdmin}
                    />
                  </div>
                )}
              </div>
            ...
            <div>
              <button
                ...
                className="bg-white rounded m-5 p-1 font-lato"
                type="button"
              >
                Iniciar Sesion
              </button>
