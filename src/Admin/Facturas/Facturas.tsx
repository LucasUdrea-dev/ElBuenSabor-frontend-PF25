...
export default function Facturas() {
  ...
  const anularFactura = async (factura: Factura) => {
    // const URL = `${host}/api/Factura/${factura.id}/anular`
        ...
        <div className="bg-white w-11/12 m-auto rounded-2xl">
          ...
          <div className="w-full pb-10">
            ...
            {facturasMostradas.length > 0 &&
              facturasMostradas.map((factura, index) => {
                if (
                  ...
                  return (
                    <div
                      key={factura.id}
                      className="text-3xl w-full grid grid-cols-6 *:border-1 *:border-r-0 *:border-gray-500 *:w-full *:p-5 *:border-collapse text-center *:flex *:items-center *:justify-center font-lato"
                    >
                      <div>
                      ...
                      <div className="flex items-center justify-center gap-3">
                        ...
                        <div className="flex gap-2">
                          ...
                          >
                            <img
                              className="h-10 w-10"
                              src="/public/svg/DetallePreparacion.svg"
                              alt="Ver detalles"
                            />
                          </button>
                          <button
              ...
              <div className="text-gray-500 flex items-center pt-10 pr-20 justify-end gap-2 text-2xl *:h-10 font-lato">
                ...
                <div className="h-10 flex items-center">
                  <h4>
                    ...
                    -
                    {paginaSeleccionada * cantidadPorPagina <
                    facturasMostradas.length
                      ? paginaSeleccionada * cantidadPorPagina
                      : facturasMostradas.length}{" "}
                    de {facturasMostradas.length}
                  </h4>
                </div>
                ...
                <button
                  onClick={() =>
                    setPaginaSeleccionada((prev) => {
                      if (
                        paginaSeleccionada <
                        Math.ceil(facturasMostradas.length / cantidadPorPagina)
                      ) {
                        return prev + 1;
                      }
                      return prev;
