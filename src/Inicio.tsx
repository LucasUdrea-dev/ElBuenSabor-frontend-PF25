...
export default function Inicio() {
  ...
  //Como funciona
  const secciones =
    "bg-[#F2B28C80] mx-auto h-auto w-2/3 rounded-4xl text-center mt-15 p-[5%]";
      ...
      <div className="bg-[#333333] h-full w-1/1 text-white font-[Playfair_Display] py-10">
        ...
        <div className="grid grid-cols-[2fr_2fr] p-10 gap-5">
          <div className="flex flex-col text-center">
            ...
            <Link
              className="bg-[#D93F21] rounded-lg m-auto text-4xl flex items-center p-5"
              to="/catalogo"
            >
        ...
        <div id="comoFunciona" className={secciones}>
          ...
          <div className="grid grid-cols-3 mt-10 gap-10">
            <div>
              ...
              <p className={parrafo}>
                Busca en nuestro catalogo y ordena por la app
              </p>
            </div>
            <div>
              ...
              <p className={parrafo}>
                ¡Facil y rapido! Podes pagar online o en la entrega
              </p>
            </div>
            <div>
              ...
              <p className={parrafo}>
                Recibi tu pedido en tu domicilio o pasa a retirarlo al local
              </p>
            </div>
          </div>
        </div>
        ...
        <div id="sobreNosotros" className={secciones}>
          <div className="grid grid-cols-[3fr_2fr] gap-5">
            ...
            <img
              className="m-auto h-[35rem] rounded-4xl object-cover"
          ...
          <div className="text-left grid grid-rows-[1fr_5fr] gap-10">
            ...
            <div className="grid grid-rows-4 gap-8">
              ...
              <div className="flex items-center">
                ...
                <a href="callto:+5492615874398" className={subtitulos}>
                  +54 9 2615874398
                </a>
              </div>
              <div className="flex items-center">
                <img src="/svg/gmail.svg" alt="" />
                <a href="mailto:ElBuenSabor@gmail.com" className={subtitulos}>
