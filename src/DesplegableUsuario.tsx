...
export default function DesplegableUsuario({alCerrarSesion, cambiarDesplegableUsuario}: Props) {
    ...
    return(
        ...
        <div className="bg-[#444444] text-white text-lg">
            <button onClick={()=>{
                cambiarDesplegableUsuario()
